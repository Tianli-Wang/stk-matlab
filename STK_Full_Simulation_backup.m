...
% 3. 定义本次仿真的�?�文件夹 (带时间戳)
% run_root_folder = fullfile(base_root, sprintf('RawData_BBS'));
run_root_folder = fullfile(base_root, sprintf('RawData_NLS'));
